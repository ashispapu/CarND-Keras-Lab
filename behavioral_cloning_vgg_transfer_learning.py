...
def img_pre_process(img):
    ...
    """
    # Remove the unwanted top scene to make model learn only the track 
    roi = img[60:140, :, :]
...
## Define the VGG16  model with changes 
def get_model():
    """
    Defines the model
    ...
    """
    model.load_weights(PATH + 'vgg16_weights.h5', by_name=True)
